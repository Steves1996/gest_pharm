                        ...
                        <div class="form-group">
                            ...
                            <select name="product_id" id="product_id"
                                ...
                                while ($row = $prod_qry->fetch_assoc()):
                                    ?>
                                    <option value="<?php echo $prod_id = $row['product_id'] ?>"
                                        <?php echo ((isset($product_id) && $product_id == $row['product_id']) || (isset($_GET['pid']) && $_GET['pid'] == $row['product_id'])) ? 'selected' : '' ?>><?php echo $row['name'] . '-' . $row['product_code'] ?></option>
                                <?php endwhile; ?>
                            </select>
                        </div>
                    <?php else: ?>
